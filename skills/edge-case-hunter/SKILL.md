...
description: Use when exhaustive edge-case analysis is needed for code, specs, or diffs, especially around branches and boundary conditions. Orthogonal to adversarial review - method-driven, not attitude-driven.
---
...
- **content** — Content to review: diff, full file, function, or spec
